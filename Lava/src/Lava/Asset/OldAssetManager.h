...
protected:
	...
	Map<VolcaniCore::UUID, Ref<Graphics::Mesh>> m_MeshAssets;
	Map<VolcaniCore::UUID, Ref<Graphics::Texture>> m_TextureAssets;
	Map<VolcaniCore::UUID, Ref<Graphics::Cubemap>> m_CubemapAssets;
	Map<VolcaniCore::UUID, Ref<Graphics::ShaderPipeline>> m_ShaderAssets;
	Map<VolcaniCore::UUID, Ref<Audio::Sound>> m_AudioAssets;
	Map<VolcaniCore::UUID, Ref<Script::ScriptModule>> m_ScriptAssets;
	Map<VolcaniCore::UUID, Ref<Graphics::Material>> m_MaterialAssets;
...
template<>
inline Ref<Graphics::Mesh> AssetManager::Get(Asset asset) const {
...
template<>
inline Ref<Graphics::Texture> AssetManager::Get(Asset asset) const {
...
template<>
inline Ref<Graphics::Cubemap> AssetManager::Get(Asset asset) const {
...
template<>
inline Ref<Graphics::ShaderPipeline> AssetManager::Get(Asset asset) const {
...
template<>
inline Ref<Graphics::Material> AssetManager::Get(Asset asset) const {
