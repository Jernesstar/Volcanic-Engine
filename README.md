...
<!-- [![Discord](https://img.shields.io/discord/633826290415435777.svg?style=for-the-badge&color=%235a64f6)]() -->
...
The engine is built on top of the best libraries to date
...
## The *LavaFlow* system
Different workflows depending on the type of game being developed
...
Some features are:
- Hot reloading of all assets
- Built-in script editor with:
    - Linting
    - On-hover descriptions for functions and classes
    - Line-by-line debugger with variable inspector

With the *LavaFlow* system, the Editor can be customized infinitely to fit your workflow
### The SceneTab (DefaultFlow)
![SceneTab](Magma/assets/images/SceneTabScreenshot.png)
### The UITab (DefaultFlow)
![UITab](Magma/assets/images/UITabScreenshot.png)

## Lava
### The Library
Defines the App class, the bridge between your **angelscript** app and VolcanicEngine's **C++** application.  
Defines the numerous classes, functions and bindings for the scripting language.
### The Runtime
...
VolcanicEngine is different. You build your engine, centered around your needs.  
Because, really, game dev is about ***ideas***. Not scenes, or StaticMesh objects, or Nodes.  
***Ideas***.
...
```
The Makefiles/solution and project files will have been generated. After this step is complete, run
```bash
scripts/build.sh
```
on Linux and for Windows, run
```cmd
scripts/build.bat
```
