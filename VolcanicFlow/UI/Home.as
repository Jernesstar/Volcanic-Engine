...
UIComponent HomePage() {
    ...
    auto __title_0 =
        __root_0.CreateElement("Title",
        {
            { "text", "This is the homepage" },
            { "class", className }
        });
    auto __header_0 = __root_0.CreateElement("Header", { }, username + "_user");
    auto __root_1 = __root_0.CreateElement("Container");
    {
        __root_1.CreateElement("Button"
        {
            { "style", "HomeButton" },
            { "icon", "HomeButton.svg" }
        });
    ...
    auto __root_2 = __root_0.CreateElement("Container");
    {
        auto projects = Projects.Top(5);
        for(uint i = 0; i < projects.Count(); i++) {
            auto p = projects[i];
            __root_2.CreateElement("Label",
            {
                { "text", p.Name }
            });
            __root_2.CreateElement("Icon",
            {
                { "path", "ProjectIcon.svg" }
            });
        }
    }
